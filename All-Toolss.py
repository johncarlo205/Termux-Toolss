...
24. Install BlackArch                     [working]
25. Install social engineering Tool kit   [working]
26. Install HTTrack                       [working]
27. Install Beef-xss
28. Coming soon
==============================================
99. Exit
...
while loop:
    ...
    if what == "1":
        ...
        os.system("pkg install -y git")
        os.system("pkg install -y curl")
        os.system("cd /data/data/com.termux/files/home && curl -LO  https://raw.githubusercontent.com/Hax4us/blackarch_termux/master/blackarch")
        os.system("cd /data/data/com.termux/files/home && chmod +x blackarch")
        os.system("cd /data/data/com.termux/files/home && ./blackarch")
        os.system("cd /data/data/com.termux/files/home")
        print("====================================")
        ...
        print("[+] Go to setoolkit folder and setup files")
        print("====================================")
        rmenu = input("[?] Back to Menu? (y/n): ")
        if rmenu == "y":
            menu()
        ...
        os.system("cd /data/data/com.termux/files/home && ./httrack")
        os.system("cd /data/data/com.termux/files/home")
        os.system("cd /data/data/com.termux/files/home")
        print("====================================")
        print("[+] HTTrack installed successfully :)")
        print("[+] Go to HTTrack folder and setup")
        print("====================================")
        rmenu = input("[?] Back to Menu? (y/n): ")
        if rmenu == "y":
            menu()
